...
function isMAC48Address(n) {
  ...
  const regexp = new RegExp('\\p{Hex_Digit}\\p{Hex_Digit}-\\p{Hex_Digit}\\p{Hex_Digit}-\\p{Hex_Digit}\\p{Hex_Digit}-\\p{Hex_Digit}\\p{Hex_Digit}-\\p{Hex_Digit}\\p{Hex_Digit}-\\p{Hex_Digit}\\p{Hex_Digit}', 'iu');
